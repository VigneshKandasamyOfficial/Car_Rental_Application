...
{   $fromDate = new DateTime($result->FromDate);
  ...
  $totalHours = $fromDate->diff($toDate)->h;

    // Calculate the total number of days
    $totalDays = $fromDate->diff($toDate)->d;

$totalCost = ($totalDays * 24 + $totalHours) * $result->PricePerDay;
  ?>
...
<table>
  ...
  <tr>
    <td><?php echo htmlentities($result->VehiclesTitle);?>, <?php echo htmlentities($result->BrandName);?></td>
     <td><?php echo htmlentities($result->FromDate);?></td>
      ...
      <?php if($totalHours==0)
        { ?>
        <td> <?php echo htmlentities($totalDays * 24 );?></td>
        <?php } else { ?>
       <td><?php echo htmlentities($totalHours);?></td>
       <?php } ?>
  ...
  <tr>
    ...
    <th><?php echo htmlentities($totalCost);?></th>
  </tr>
</table>
<hr />
              <?php }}  else { ?>
