      ...
      <div class="col-md-9">
        <div class="main_features">
          ...
          <?php if($result->Status==1)
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Available</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
        </div>
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              ...
              <input type="datetime-local" class="form-control" id="fromdate" name="fromdate" placeholder="From Date" required>
            </div>
            <div class="form-group">
              <label>To Date:</label>
              <input type="datetime-local" class="form-control" id="todate" name="todate" placeholder="To Date" required>
            </div>
            <div class="form-group">
